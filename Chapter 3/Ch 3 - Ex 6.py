...
print("I'm sorry", guests2.pop(1)+", but I can only invite two people for dinner") #.pop() is to remove a specific item from the list but not delete
print(guests2[0], "and", guests2[1], "are still invited for dinner\n") #after removing specific items, the number in the list now starts from 0 and ends with 1. Different from the previous list which was 0 to 2

del guests2[0] 
del guests2[0] #del is used to delete the rest of the items in the list

print(guests2) #print to show that nothing is left in the list
