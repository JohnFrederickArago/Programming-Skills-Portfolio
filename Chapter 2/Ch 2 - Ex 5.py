...
a = 50 
b = 6
c = int(a/b) #I divided the values of a and b
print("The girl can get", c, "pieces of USB sticks\n") 

d = int(b*c) #I multiplied the value of b and c
e = int(a-d) #then subtracted the value of a and d
print("The girl will have £", e, "left") 
